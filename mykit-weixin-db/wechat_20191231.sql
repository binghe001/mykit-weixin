...
-- ----------------------------
-- Table structure for mp_wechat_qrcode
-- ----------------------------
DROP TABLE IF EXISTS `mp_wechat_qrcode`;
CREATE TABLE `mp_wechat_qrcode` (
  `id` varchar(32) NOT NULL COMMENT '默认的id',
  `t_create_time` varchar(30) DEFAULT '' COMMENT '创建的时间yyyy-MM-dd HH:mm:ss',
  `t_create_date` varchar(20) DEFAULT '' COMMENT '创建日期yyyy-MM-dd',
  `t_month_sharding` varchar(20) DEFAULT '' COMMENT '分片字段yyyyMM',
  ...
  `t_remark` varchar(255) DEFAULT '' COMMENT '备注',
  `t_last_modify_time` varchar(30) DEFAULT '' COMMENT '最后修改时间 yyyy-MM-dd HH:mm:ss',
  `foreign_system_id` varchar(50) DEFAULT '' COMMENT '业务系统id',
  `foreign_system` varchar(50) DEFAULT '' COMMENT '业务系统类型',
  `foreign_id` varchar(50) DEFAULT '' COMMENT '用户在业务系统的id',
  `foreign_type` varchar(50) DEFAULT '' COMMENT '用户在业务系统的类型',
  `qrcode_info` varchar(255) DEFAULT '' COMMENT '二维码中的信息',
