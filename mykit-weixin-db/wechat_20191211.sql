...
-- 20191211新增---
alter table mp_wechat_template_msg_log add column t_retry varchar (30) not null default 'retry_false' comment '是否是重试的结果retry_false:否 retry_true:是';
